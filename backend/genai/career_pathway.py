...
Format: Please present the resources in an organized list, categorizing each type for clarity and give it in format dont use your formatting just simple that can be formatted easliyand give links on new lines .
"""
